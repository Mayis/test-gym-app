  ...
  return (
    <div className="flex w-full justify-center py-10">
      <div className="flex max-w-[1200px] flex-col space-y-6 overflow-hidden px-4">
        <div>
          <h2 className="font-tektur-bold text-start text-3xl text-white sm:pl-[50px] sm:text-5xl">WHY CHOOSE US </h2>
        </div>
        <div className="relative flex w-full items-center justify-center sm:space-x-4">
          ...
          <div className="w-full px-4 sm:w-[90%]">{isMobile ? <MobileOnlyItems /> : <SwiperCarousel />}</div>
          <div className="hidden sm:flex">
